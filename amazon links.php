 ...
 */
function deactivate_amazon links() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/class-amazon links-deactivator.php';
	Amazon_Links_Deactivator::deactivate();
}

register_activation_hook( __FILE__, 'activate_amazon links' );
register_deactivation_hook( __FILE__, 'deactivate_amazon links' );
